...
See [September 16, 2026 sync report](upstream-20260916.md) for the upstream changes, removed subagent-provider commit, conflict resolutions, and validation limits.
